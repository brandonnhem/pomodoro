...
function Settings({ isOpen, toggleSettings }) {
  ...
  return (
    <div className="settings-modal" style={{opacity: `${isOpen ? 1 : 0}`}}>
      <div
        ...
        <section className="font-section">
          ...
          <div className="font-modifier">
            <div
              ...
              id="font-1"
              style={{
                backgroundColor: `${font === "font1" ? "#161932" : "#EFF1FA"}`,
                color: `${font === "font1" ? "#FFFFFF" : "#1E213F"}`,
              }}
            ...
            <div
              ...
              id="font-2"
              style={{
                backgroundColor: `${font === "font2" ? "#161932" : "#EFF1FA"}`,
                color: `${font === "font2" ? "#FFFFFF" : "#1E213F"}`,
              }}
            ...
            <div
              ...
              id="font-3"
              style={{
                backgroundColor: `${font === "font3" ? "#161932" : "#EFF1FA"}`,
                color: `${font === "font3" ? "#FFFFFF" : "#1E213F"}`,
              }}
          ...
          <div className="color-modifier">
            ...
            >
              <div
                ...
                style={{ display: `${color === "color1" ? "block" : "none"}` }}
              >
                <svg
                  width="15"
                  height="11"
